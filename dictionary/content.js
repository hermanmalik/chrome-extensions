...
const TRANSLATION_SYSTEM_PROMPT = 'Translate the user text to English if it is not in English, and to Spanish if it is in English. Output ONLY the translated text. If the input text is a single word, you may output multiple possible comma-separated translations.'; // GPT's translation prompt
...
function loadPopups(event) {
    ...
    if (selectedText.length > 3) {
        translateButton = makeMiniPopup(translateText, "tr", 25);
    }
